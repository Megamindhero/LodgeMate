        ...
        <div style={{ background:'var(--card-bg)', border:'1px solid var(--border)', borderRadius:'1.5rem', overflow:'hidden', boxShadow:'var(--card-shadow)' }}>
          ...
          <div style={{ padding:'1.75rem 2rem 2rem' }}>
            ...
            {safeVideo && (() => {
              ...
              let embedUrl = safeVideo;
              try {
                const u = new URL(safeVideo);
                if (u.hostname.includes('youtube.com') || u.hostname.includes('youtu.be')) {
                  let vid = u.searchParams.get('v') || u.pathname.replace(/^\//, '').split('/')[0];
                  if (u.hostname === 'youtu.be') vid = u.pathname.replace(/^\//, '');
              ...
              return (
                <div style={{ marginBottom:'1.5rem' }}>
                  ...
                  <div style={{ position:'relative', width:'100%', paddingBottom:'56.25%', borderRadius:'1rem', overflow:'hidden', background:'#000', border:'1px solid var(--border)' }}>
                    <iframe
                      src={embedUrl}
