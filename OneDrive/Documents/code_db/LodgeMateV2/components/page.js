      ...
      <footer style={{ borderTop:'1px solid var(--border)', padding:'2rem 1.5rem' }}>
        <div style={{ maxWidth:'88rem', margin:'0 auto', display:'flex', flexWrap:'wrap', alignItems:'center', justifyContent:'space-between', gap:'1rem' }}>
          <div style={{ display:'flex', alignItems:'center', gap:'0.625rem' }}>
            <div style={{ width:'1.75rem', height:'1.75rem', borderRadius:'0.5rem', background:'linear-gradient(135deg,#5b21b6,#7c3aed)', display:'flex', alignItems:'center', justifyContent:'center' }}>
              <span style={{ fontSize:'0.8rem' }}>🏠</span>
            </div>
            <span style={{ fontWeight:900, fontSize:'0.9375rem', color:'var(--text)', letterSpacing:'-0.02em' }}>LodgeMate</span>
          </div>
          <p style={{ fontSize:'0.8125rem', color:'var(--text-3)', margin:0 }}>&copy; {new Date().getFullYear()} LodgeMate · Minna, Niger State · All rights reserved</p>
        </div>
      </footer>
    </div>
  );
      ...
      <div style={{ maxWidth:'90rem', margin:'0 auto' }}>
        <div className="anim-up" style={{ marginBottom:'3rem' }}>
          <div className="section-label" style={{ marginBottom:'0.75rem' }}>
            <i className="fas fa-home" style={{ fontSize:'0.65rem' }}></i>Available Now
          </div>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-end', flexWrap:'wrap', gap:'1rem' }}>
            <div>
              ...
              <p style={{ color:'var(--text-2)', marginTop:'0.5rem', fontSize:'0.9375rem' }}>Handpicked across Gidan-Kwano, Gidan-Mango, Kpakungun &amp; Gurara</p>
            </div>
